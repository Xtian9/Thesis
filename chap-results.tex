...
Simplified models of supersymmetry are simulated with a range of gluino/squark 
...
%%%or a metastable gluino, % this is true for stopped search or non-interacting 
%LLP, but there's hscp...
%%%as well as models with a very compressed mass spectrum.
...
%This is because dedicated techniques require a minimum decay length and a 
%decay that occurs within the detector and within the time frame of an LHC run, 
%as well as a sufficiently large mass difference such that the decay products 
%can be reconstructed.

%%% for you reference: rob 170918_LL_IC_CMS slide 14 cartoon summary limit plot

% note that dedicated searches don't show compressed (smallest is deltam 100 in 
%atlas disp verts)
