...
Jets are reconstructed by clustering Particle Flow candidates using the \antikt 
...
vector sum of the transverse energy of all PF candidates in the event. 
The jet energy corrections described in Sec.X are propagated as a correction to 
...
Sec.~\ref{sec:detector-jecs}. 
In this case, this does not involve a reweighting of the simulated events.
...
\centering
\subfloat[$\njet=4, \nb=2, 
\scalht=$~600-750~GeV]{\includegraphics[width=0.49\textwidth]{figs/analysis/mht_eq2b_eq4j_ht_600_800_SingleMu_Graph}}
\subfloat[$\njet=2, \nb=1, 
\scalht=$~400-500~GeV]{\includegraphics[width=0.49\textwidth]{figs/analysis/mht_eq1b_eq2j_ht_400_500_SinglePhoton_Graph}}
