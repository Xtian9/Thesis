...
energy mismeasurements is suppressed as much as possible (to <1\% of the total 
background) using dedicated variables. % the variables described in 
...
LHC, at centre of mass energies of 7, 8 and 13~TeV, and for a range of 
...
The SUSY %and DM 
simplified models are generated with \textsc{MadGraph5}. For each 
...
as well as glueball-like ($\gluino$g) states with probability 10\%. The 
interaction of R-hadrons with the detector material is simulated with 
