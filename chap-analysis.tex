...
\begin{table}[ht!]
%FIXME: Table: jet ID requirements (have 3 columns for each eta region, merge 
...
%[fixme: tails of Gaussian resolution] 
...
%[FIXME - already defined in MHT definition?]
...
(Sec.~\ref{sec:analysis-eventselection}) except the \alphat requirement. The 
...
events satisfying the signal region selections 
(Sec.~\ref{sec:analysis-eventselection}) except the \bdphi requirement. The 
ability 
...
consistent with unity. [FIXME: remove ratio plot and fix axis label? Update to 
36fb]}
\label{fig:mhtmet}
\end{center}
\end{figure}
...
%[fixme: not sure if this last sentence is needed or is already 
...
%todo (in particular DM and compressed SUSY models), 
...
%[todo] thresholds kept relatively low thanks to L1 upgrade.
...
%TODO. Jet energy response/scale. 
