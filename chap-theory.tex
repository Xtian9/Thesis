...
%hierarchy problem is the question that asks why the weak force is 10^24 times 
...
%physics at the TeV scale - not quite true, quadratic divergence still cancels 
%out
...
%gluino and quarks or gluons [22], known as an R-hadron
...
%paper: all other particles assumed much heavier to be produced directly
...
%T2qq: Two scenarios are considered for LF squarks: one with an eightfold mass 
%degeneracy for qeL and qeR with qe = fue, de,es,ecg and the other with just a 
%single 464 light squark (ueL)
The results of this search are interpreted using a total of nine families of 
